            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="mt-2 flex items-center gap-2 text-xs text-blue-600 dark:text-blue-400">
                  ...
                  <span>{limits.userType === 'guest' ? t('guestUser') : t('regularUser')}</span>
                  <span>•</span>
                  <span>{totalItems}/{limits.maxItems} {t('items')}</span>
                  <span>•</span>
        ...
        >
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-xl p-4 shadow-sm">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`h-8 w-8 rounded-full flex items-center justify-center ${isAuthenticated
                  ? 'bg-green-100 dark:bg-green-900/30'
                  : 'bg-yellow-100 dark:bg-yellow-900/30'
                  }`}>
                  <User className={`h-4 w-4 ${isAuthenticated
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
                    {isAuthenticated ? t('authenticatedUser') : t('guestUser')}
                  </p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    {isAuthenticated
                      ? `${t('email')}: ${user?.email || t('unknown')}`
                      : t('loginToSaveCart')
                    }
                  </p>
                </div>
