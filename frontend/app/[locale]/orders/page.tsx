                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full sm:w-auto">
                      <motion.span
                        className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-semibold flex items-center gap-1.5 sm:gap-2 border shadow-sm flex-shrink-0 ${getStatusColor(order.status)} ${order.status === 'confirmed' ? 'border-green-200/50 dark:border-green-700/50' :
                      ...
                      <div className="flex items-center gap-2 ml-auto sm:ml-0">
                        ...
                        <motion.button
                          ...
                          className="p-2 sm:p-3 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 bg-gray-50 dark:bg-gray-700/50 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg sm:rounded-xl transition-all duration-200 border border-gray-200/50 dark:border-gray-600/50"
                          title={t('downloadInvoiceTooltip') || 'Download Invoice'}
                          whileHover={{ scale: 1.1, rotate: -5 }}
                          whileTap={{ scale: 0.9 }}
                        >
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-4">
                    ...
                    <motion.span
                      className={`px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium ${selectedOrder.payment_status === 'paid'
