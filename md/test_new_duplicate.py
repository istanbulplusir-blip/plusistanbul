#!/usr/bin/env python3
"""
Test duplicate booking prevention with a new product.
"""
...
def test_new_duplicate():
    """Test duplicate booking prevention with a new product."""
    print("🧪 New Duplicate Booking Test...")
    
    # Test data with a different schedule
    test_data = {
        "product_type": "tour",
        ...
        "quantity": 1,
        "booking_data": {
            "schedule_id": "6b40dbdd-b545-4969-adfc-4ca3145767f6",  # Different schedule
            "participants": {
                "adult": 1,
                "child": 0,
                "infant": 0
