#!/usr/bin/env python3
"""
Simple test for cart duplicate prevention.
"""
...
def test_simple_cart_duplicate():
    """Simple test for cart duplicate prevention."""
    print("🧪 Simple Cart Duplicate Test...")
    ...
    print("\n4️⃣ Trying to add to cart again (should be prevented)...")
    ...
    if cart_response2.status_code == 400:
        ...
        if error_data.get('code') == 'DUPLICATE_CART_ITEM':
            print("   ✅ Duplicate cart item correctly prevented!")
            return True
        else:
...
if __name__ == "__main__":
    success = test_simple_cart_duplicate()
    if success:
        print("\n🎉 Test PASSED: Duplicate cart item prevention is working!")
    else:
        print("\n❌ Test FAILED: Duplicate cart item prevention is not working!")
