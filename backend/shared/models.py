...
class SiteSettings(BaseModel):
    ...
    # Default Hero Slider Content (when no slides exist)
    default_hero_title = models.CharField(
        max_length=200,
        default='Welcome to Peykan Tourism',
        verbose_name=_('Default Hero Title'),
        help_text=_('Title shown when no hero slides exist')
    )
    default_hero_subtitle = models.CharField(
        max_length=300,
        default='Discover amazing places',
        verbose_name=_('Default Hero Subtitle'),
        help_text=_('Subtitle shown when no hero slides exist')
    )
    default_hero_description = models.TextField(
        default='Your gateway to amazing travel experiences',
        verbose_name=_('Default Hero Description'),
        help_text=_('Description shown when no hero slides exist')
    )
    default_hero_button_text = models.CharField(
        max_length=50,
        default='Explore Tours',
        verbose_name=_('Default Hero Button Text'),
        help_text=_('Button text shown when no hero slides exist')
    )
    default_hero_button_url = models.CharField(
        max_length=200,
        default='/tours',
        verbose_name=_('Default Hero Button URL'),
        help_text=_('Button URL when no hero slides exist')
    )
...
class NavigationMenu(BaseTranslatableModel):
    """
    مدیریت منوی ناوبری سایت
    """
    ...
    order = models.PositiveIntegerField(default=0, verbose_name=_('Display Order'))
    is_active = models.BooleanField(default=True, verbose_name=_('Is Active'))
    is_external = models.BooleanField(default=False, verbose_name=_('External Link'))
    target_blank = models.BooleanField(default=False, verbose_name=_('Open in New Tab'))
