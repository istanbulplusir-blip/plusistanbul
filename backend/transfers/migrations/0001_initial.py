    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('slug', models.SlugField(max_length=255, unique=True, verbose_name='Slug')),
                ('vehicle_type', models.CharField(blank=True, choices=[('sedan', 'Sedan'), ('suv', 'SUV'), ('van', 'Van'), ('sprinter', 'Sprinter'), ('bus', 'Bus'), ('limousine', 'Limousine')], max_length=20, null=True, verbose_name='Vehicle type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimated_duration_minutes', models.PositiveIntegerField(default=45, help_text='Estimated travel time in minutes', verbose_name='Estimated duration (minutes)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='USD', max_length=3, verbose_name='Currency')),
                ('pricing_metadata', models.JSONField(blank=True, default=dict, verbose_name='Pricing metadata')),
