...
Automated testing of all User system components
"""
...
class UserSystemTestSuite:
    """Comprehensive test suite for User system"""
    ...
    def get_auth_headers(self, user):
        ...
        if user not in self.test_tokens:
            ...
            self.test_tokens[user] = {
                'access': str(refresh.access_token),
                'refresh': str(refresh)
            }
        return {'Authorization': f'Bearer {self.test_tokens[user]["access"]}'}
    ...
    def test_3_agent_profile_creation(self):
        ...
        try:
            ...
            # Create AgentProfile manually (it's not automatic)
    ...
    def test_13_duplicate_email_registration(self):
        ...
        try:
            ...
            self.log_test_result(
                '13', 'Duplicate Email Registration',
    ...
    def test_14_invalid_login_credentials(self):
    ...
    def run_all_tests(self):
        """Run all tests"""
        print("🚀 Starting User System Test Suite")
        print("=" * 50)
        ...
        test_methods = [
            ...
            self.test_11_rate_limiting,
            self.test_12_password_change,
            self.test_13_duplicate_email_registration,
            self.test_14_invalid_login_credentials,
            self.test_15_admin_user_management,
        ]
    ...
    def generate_final_report(self):
        ...
        with open('user_system_test_results.json', 'w') as f:
            json.dump(self.test_results, f, indent=2)
        
        print(f"\n📄 Detailed results saved to: user_system_test_results.json")
...
if __name__ == '__main__':
    ...
    # Run test suite
    test_suite = UserSystemTestSuite()
